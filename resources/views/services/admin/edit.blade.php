        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form method="post" action="{{ route(($prefix ?? '') . 'services.update', $service->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="emails" value="{{ old('emails', $service->emails) }}" placeholder="adresy email" />
                            </div>
