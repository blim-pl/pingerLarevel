        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="/pages/create" class="portfolio-link" title="Dodaj stronę">
                        <div class="caption">
                ...
                <div class="col-sm-4 portfolio-item">
                    <a href="/services/create" class="portfolio-link" title="Dodaj usługę">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-sm-4 portfolio-item">
                    <a href="/services" class="portfolio-link" title="Usługi">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
